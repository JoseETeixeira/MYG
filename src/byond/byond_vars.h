#ifndef _BYOND_VARS_H
#define _BYOND_VARS_H
...
public:
    ...
    static inline std::string   BEOF = "eof"; // remember to change EOF to BEOF everywhere
    static inline std::string   EXECUTOR = "executor";
    static inline std::string   EYE = "eye";
    static inline std::string   FALLOFF = "falloff";
    static inline std::string   BFILE = "file"; // remember to change FILE to BFILE everywhere
