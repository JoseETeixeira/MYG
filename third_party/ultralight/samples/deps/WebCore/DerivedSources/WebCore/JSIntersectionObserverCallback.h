...
public:
    ...
    // Functions
    CallbackResult<typename IDLVoid::ImplementationType> handleEvent(typename IDLSequence<IDLInterface<IntersectionObserverEntry>>::ParameterType entries, typename IDLInterface<IntersectionObserver>::ParameterType observer) override;
