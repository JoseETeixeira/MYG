...
template<> Optional<MediaSource::EndOfStreamError> parseEnumeration<MediaSource::EndOfStreamError>(JSC::ExecState&, JSC::JSValue);
...
template<> JSC::JSString* convertEnumerationToJS(JSC::ExecState&, MediaSource::ReadyState);

template<> Optional<MediaSource::ReadyState> parseEnumeration<MediaSource::ReadyState>(JSC::ExecState&, JSC::JSValue);
