...
class JSDatabaseCallback final : public DatabaseCallback {
public:
    ...
    // Functions
    CallbackResult<typename IDLVoid::ImplementationType> handleEvent(typename IDLInterface<Database>::ParameterType database) override;
