...
class WEBCORE_EXPORT JSStringCallback final : public StringCallback {
public:
    ...
    // Functions
    CallbackResult<typename IDLVoid::ImplementationType> handleEvent(typename IDLDOMString::ParameterType data) override;
...
WEBCORE_EXPORT JSC::JSValue toJS(StringCallback&);
