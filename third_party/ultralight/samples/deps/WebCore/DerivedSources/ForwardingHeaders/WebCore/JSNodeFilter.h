...
class JSNodeFilter final : public NodeFilter {
public:
    ...
    // Functions
    CallbackResult<typename IDLUnsignedShort::ImplementationType> acceptNode(typename IDLInterface<Node>::ParameterType node) override;
